...
# Shouvik Sharma # December 25, 2018
...
###### 1. Merge the training and the test sets to create one data set.
setwd('C:/Users/HP/Desktop/Data Science/Getting & Cleaning Data/Week 4/project/UCI HAR Dataset
...
# Tidy Data with averaging each activity and each subject as
